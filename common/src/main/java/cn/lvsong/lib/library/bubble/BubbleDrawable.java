...
public class BubbleDrawable extends Drawable {
    ...
    private BubbleDrawable(Builder builder) {
        ...
        this.mAroundRadius = builder.mAroundRadius;
    ...
    private void setUpLeftPath(RectF rect, Path path) {
        ...
        path.moveTo(mArrowWidth + rect.left + mAroundRadius, rect.top);
        path.lineTo(rect.width() - mAroundRadius, rect.top);
        path.arcTo(new RectF(rect.right - mAroundRadius, rect.top, rect.right,
                mAroundRadius + rect.top), 270, 90);
        path.lineTo(rect.right, rect.bottom - mAroundRadius);
        path.arcTo(new RectF(rect.right - mAroundRadius, rect.bottom - mAroundRadius,
                rect.right, rect.bottom), 0, 90);
        path.lineTo(rect.left + mArrowWidth + mAroundRadius, rect.bottom);
        path.arcTo(new RectF(rect.left + mArrowWidth, rect.bottom - mAroundRadius,
                mAroundRadius + rect.left + mArrowWidth, rect.bottom), 90, 90);
        ...
        path.lineTo(rect.left + mArrowWidth, rect.top + mAroundRadius);
        path.arcTo(new RectF(rect.left + mArrowWidth, rect.top, mAroundRadius
                + rect.left + mArrowWidth, mAroundRadius + rect.top), 180, 90);
        path.close();
    }
    ...
    private void setUpTopPath(RectF rect, Path path) {
        ...
        path.moveTo(rect.left + Math.min(mArrowPosition, mAroundRadius), rect.top + mArrowHeight);
        ...
        path.lineTo(rect.right - mAroundRadius, rect.top + mArrowHeight);

        path.arcTo(new RectF(rect.right - mAroundRadius,
                rect.top + mArrowHeight, rect.right, mAroundRadius + rect.top + mArrowHeight), 270, 90);
        path.lineTo(rect.right, rect.bottom - mAroundRadius);

        path.arcTo(new RectF(rect.right - mAroundRadius, rect.bottom - mAroundRadius,
                rect.right, rect.bottom), 0, 90);
        path.lineTo(rect.left + mAroundRadius, rect.bottom);

        path.arcTo(new RectF(rect.left, rect.bottom - mAroundRadius,
                mAroundRadius + rect.left, rect.bottom), 90, 90);
        path.lineTo(rect.left, rect.top + mArrowHeight + mAroundRadius);
        path.arcTo(new RectF(rect.left, rect.top + mArrowHeight, mAroundRadius
    ...
    private void setUpTopRightPath(RectF rect, Path path) {
        ...
        path.moveTo(rect.left + mAroundRadius, rect.top + mArrowHeight);
        path.lineTo(rect.right - mAroundRadius - mArrowPosition, rect.top + mArrowHeight);
        path.lineTo(rect.right - mAroundRadius - mArrowPosition + mArrowWidth / 2, rect.top);
        path.lineTo(rect.right - mAroundRadius - mArrowPosition + mArrowWidth, rect.top + mArrowHeight);
    ...
    private void setUpRightPath(RectF rect, Path path) {
        ...
        path.moveTo(rect.left + mAroundRadius, rect.top);
        path.lineTo(rect.width() - mAroundRadius - mArrowWidth, rect.top);
        path.arcTo(new RectF(rect.right - mAroundRadius - mArrowWidth,
                rect.top, rect.right - mArrowWidth, mAroundRadius + rect.top), 270, 90);
        ...
        path.lineTo(rect.right - mArrowWidth, rect.bottom - mAroundRadius);

        path.arcTo(new RectF(rect.right - mAroundRadius - mArrowWidth, rect.bottom - mAroundRadius,
        ...
        path.arcTo(new RectF(rect.left, rect.top, mAroundRadius
                + rect.left, mAroundRadius + rect.top), 180, 90);
        path.close();
    }
    ...
    private void setUpBottomPath(RectF rect, Path path) {
        ...
        path.lineTo(rect.width() - mAroundRadius, rect.top);
        path.arcTo(new RectF(rect.right - mAroundRadius,
                rect.top, rect.right, mAroundRadius + rect.top), 270, 90);

        path.lineTo(rect.right, rect.bottom - mArrowHeight - mAroundRadius);
        path.arcTo(new RectF(rect.right - mAroundRadius, rect.bottom - mAroundRadius - mArrowHeight,
        ...
        path.lineTo(rect.left + Math.min(mAroundRadius, mArrowPosition), rect.bottom - mArrowHeight);

        path.arcTo(new RectF(rect.left, rect.bottom - mAroundRadius - mArrowHeight,
                mAroundRadius + rect.left, rect.bottom - mArrowHeight), 90, 90);
        path.lineTo(rect.left, rect.top + mAroundRadius);
        path.arcTo(new RectF(rect.left, rect.top, mAroundRadius
                + rect.left, mAroundRadius + rect.top), 180, 90);
        path.close();
    }
    ...
    public static class Builder {
        ...
        private float mAroundRadius = DEFAULT_ANGLE;
