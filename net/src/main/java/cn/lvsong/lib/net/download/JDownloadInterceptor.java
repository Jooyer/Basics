 ...
 * @Version: 1.0
 */
public class JDownloadInterceptor implements Interceptor {
    private JDownloadListener downloadListener;
    public JDownloadInterceptor(JDownloadListener downloadListener) {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        return response.newBuilder().body(
                new JResponseBody(response.body(), downloadListener)).build();
    }
}
