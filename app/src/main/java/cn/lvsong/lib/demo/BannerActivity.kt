...
//        "https://ss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=1545980553,2413955112&fm=26&gp=0.jpg",
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 普通用法
//        val headerBannerAdapter = CustomAdapter(datas, R.layout.item_banner_normal)
        val headerBannerAdapter = object : CommonAdapter<String>(this,R.layout.item_banner_normal,datas){
...
//        headerAndFooterWrapper.addFootView(footerView)
        ...
        rv_banner_list.postDelayed({
            datas.clear()
//            datas.add("https://ss1.bdstatic.com/70cFuXSh_Q1YnxGkpoWK1HF6hhy/it/u=3820948238,3810516733&fm=26&gp=0.jpg")
            datas.add("https://ss1.bdstatic.com/70cFuXSh_Q1YnxGkpoWK1HF6hhy/it/u=2412068931,3031791558&fm=26&gp=0.jpg")
            datas.add("http://39.105.178.65:1015/diansi/images/banner1.png")
            headerBanner.notifyDataSetChanged(datas.size)
        }, 5000)
