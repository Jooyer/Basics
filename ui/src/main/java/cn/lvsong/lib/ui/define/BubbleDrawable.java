...
public class BubbleDrawable extends Drawable {
    ...
    private void setUpTopRightPath(RectF rect, Path path) {
        ...
        path.lineTo(rect.right - mAngle - mArrowPosition, rect.top + mArrowHeight);
        path.lineTo(rect.right - mAngle - mArrowPosition + mArrowWidth / 2, rect.top);
        path.lineTo(rect.right - mAngle - mArrowPosition + mArrowWidth, rect.top + mArrowHeight);
