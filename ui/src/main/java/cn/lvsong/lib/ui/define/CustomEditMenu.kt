...
class CustomEditMenu(context: Context, attr: AttributeSet, defStyleAttr: Int) :
    ...
    private fun initView() {
        val root = LayoutInflater.from(context).inflate(R.layout.common_ui_image_text_edit_image, this, true)
        ...
        et_right_name_menu = root.findViewById(R.id.et_right_name_menu)
